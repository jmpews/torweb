...
/***/ function(module, exports, __webpack_require__) {
	...
	var _chatContainer = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./containers/chatContainer\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	//test---
	store.dispatch({
	  type: _ActionTypes.RECV_UPDATE_RECENT_MESSAGE,
	  payload: {
	    id: 2,
	    avatar: '/jmpews.png',
	    name: 'jmpews',
