...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserList = function (_React$Component) {
	    ...
	    _createClass(UserList, [{
	        ...
	        value: function set_current_user(id, avatar, name) {
	        ...
	        value: function render() {
	            ...
	            var users = recent_user_list.map(function (user, index) {
	                ...
	                return React.createElement(
	                    'div',
	                    { key: index, className: 'chat-user', 'data-other': other_id, onClick: _this.set_current_user(other_id, other_avatar, other_name) },
